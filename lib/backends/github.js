...
module.exports = class GitHubBackend {
  ...
  /**
    * @summary Return the base URL paths of the working repository
    * @function
    * @public
    *
    * @returns {Object}
    * @returns {String} The Github base url path for blobs
    * @returns {String} The Github base url path for the ui view
    *
    * @example
    * const backend = new GitHubBackend(...)
    * backend.getGithubPaths()
    */
  getGithubPaths () {
    return {
      blobPrefix: `https://raw.githubusercontent.com/${this.owner}/${this.repo}`,
      uiPrefix: `https://github.com/${this.owner}/${this.repo}`
    }
  }
